...
import { hrmEmployeeQueryInAPI } from '@/api/hrm/employee'
...
const rules = {
  postName: [{ required: true, message: '请输入', trigger: ['change'] }],
  jobNature: [{ required: true, message: '请选择', trigger: ['change'] }],
  postType: [{ validator: validatePostType, trigger: ['change'] }]
}
