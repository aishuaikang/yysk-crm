...
**最新资讯： :collision: 恒河制药 CRM 云服务免费试用。恒河制药云正式上线，包含客户关系管理系统（CRM）人力资源管理系统（CRM）、财务管理系统（FS）、无代码平台、SCRM**

体验地址：[https://www.72crm.com](http://www.72crm.com)

## 恒河制药 CRM 介绍

恒河制药 CRM 在中国的开源管理软件行业有较高的知名度。目前软件已达到千万级的用户量，开源系统下载量达到 200 多万次，已覆盖设计制造业、服务业、金融业、政府机构等多种行业。与阿里巴巴、腾讯、OPPO、航天信息、CCTV 等多家知名企业达成战略合作。
...
关注恒河制药 CRM 公众号，了解更多恒河制药资讯

<img src="https://images.gitee.com/uploads/images/2019/1202/135713_d3566c6a_345098.jpeg" width="200">

```

注：恒河制药CRM采用全新的前后端分离模式，本仓库代码中已集成前端vue打包后文件，可免去打包操作。如需调整前端代码，请单独下载前端代码
...
- 执行 npm run dev，运行项目;
- 执行成功，即可访问 http://localhost:8090，查看恒河制药 CRM;
